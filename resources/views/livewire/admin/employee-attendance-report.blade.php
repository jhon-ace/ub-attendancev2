...
@if(Auth::guard('employee')->check())
        ...
        <div class="flex items-center space-x-4">
            @if($schoolToShow)
                <p class="text-black mt-2 text-sm mb-1 hidden">School: 
                ...
                @if($departmentToShow)
                    ...
                    @if($selectedEmployeeToShow)
                        ...
                        @else
                            ...
                            <div class="flex flex-col mt-1 mb-2">
                                ...
                                <div>
                                    ...
                                    @else
                                        ...
                                        <div class="flex justify-start">
                                            <span class="mt-4">Displayed Month: &nbsp;</span>
                            ...
                            <div x-data="{ tab: 'time-in-time-out' }" class=" w-full">
                                <div class="overflow-x-auto">
                                    <!-- Tab buttons -->
                                                    ...
                                                    @foreach ($attendanceTimeIn as $attendanceIn)
                                                        ...
                                                        @if ($date !== $currentDate)
                                                            @php
                                                                ...
                                                                $firstRow = true;
                                                            @endphp
                                                            <table class="table-auto min-w-full text-center text-sm mb-4 divide-y divide-gray-200" style="table-layout: fixed;">
                                                                <thead class="bg-gray-200 text-black">
                                                                    <tr>
                                                                        <th class="border border-gray-400 px-3 py-2 w-1/4">
                                                                            Emp ID
                                                                        </th>
                                                                        <th class="border border-gray-400 px-3 py-2 w-1/4">
                                                                            Date
                                                    ...
                                                    @foreach ($attendanceTimeOut as $attendanceOut)
                                                        ...
                                                        @if ($isFirstRow)
                                                            ...
                                                            <table class="table-auto min-w-full text-center text-sm mb-4 divide-y divide-gray-200" style="table-layout: fixed;">
                                                                <thead class="bg-gray-200 text-black">
                                                                    <tr>
                                                                        <th class="border border-gray-400 px-3 py-2 w-1/3">
                                                                            Emp ID
                                                                        </th>
                                                                        <th class="border border-gray-400 px-3 py-2 w-1/3">
                                                                            Date
