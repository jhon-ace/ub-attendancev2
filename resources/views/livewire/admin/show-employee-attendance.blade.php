<div class="mb-4">
    ...
    <div class="flex justify-between mb-4 sm:-mt-4">
        <div class="font-bold text-md tracking-tight text-md text-black mt-2 uppercase">Admin Staff / Employee Attendance</div>
    </div>
    <div class="flex items-center space-x-4">
        @if($schoolToShow)
            <p class="hidden w-64 text-black mt-10 text-sm mb-1">School: <span class="text-red-500 ml-2 font-bold uppercase">{{ $schoolToShow->abbreviation }}</span></p>
        @endif
        ...
        @if($schoolToShow)
            @if($departmentToShow)
                <div class="flex justify-start">
                    <div>
                        <label for="department_id" class="block text-sm text-gray-700 md:mr-4 truncate">Display attendance:</label>
                    ...
                    <div wire:loading wire:target="selectedEmployee" class="fixed inset-0 flex justify-center items-center bg-gray-500 bg-opacity-50 z-50">
                        <div class="h-full flex mx-auto justify-center items-center space-x-2 bg-opacity-50 p-6 rounded shadow-lg">
                            <div class="flex flex-col items-center">
                                <div class="w-8 h-8 border-4 border-t-transparent border-blue-500 rounded-full animate-spin"></div>
                                <span class="text-center mt-3 text-white">Fetching data...</span>
                    ...
                    <div x-data="{ open: false }" @keydown.window.escape="open = false" x-cloak>
                        ...
                        <button @click="open = true" class="bg-blue-500 hover:bg-blue-700 text-white py-1 px-2 rounded ml-2 mt-5"><i class="fa-solid fa-calendar-days"></i> Click to view Working Hour</button>
                ...
                @if($selectedEmployeeToShow)
                    ...
                    @elseif(!$search && $attendanceTimeIn->isEmpty() && $attendanceTimeOut->isEmpty() && !$selectedAttendanceByDate->isEmpty())
                        ...
                        <p class="text-black mt-8 text-center uppercase mb-8">
                            No data available for employee 
                            <span class="text-red-500">
                                {{ $selectedEmployeeToShow->employee_id }} | {{ $selectedEmployeeToShow->employee_lastname }}, {{ $selectedEmployeeToShow->employee_firstname }} {{ $selectedEmployeeToShow->employee_middlename }}
                            </span>
                        </p>
                    @else
                        ...
                        <div class="flex justify-between mt-1 mb-2">
                            <div class="mt-2 text-sm">
                                <text class="uppercase">Selected Employee: <text class="text-red-500 font-bold">{{ $selectedEmployeeToShow->employee_lastname }}, {{ $selectedEmployeeToShow->employee_firstname }} {{ $selectedEmployeeToShow->employee_middlename }}</text>
                            </div>
                                                ...
                                                @foreach ($attendanceTimeIn as $attendanceIn)
                                                    ...
                                                    <tr class="hover:bg-gray-100">
                                                        ...
                                                        <td class="text-black border border-gray-400 uppercase">
                                                            ...
                                                            @elseif ($display === "Absent")
                                                                <span style="color: red;" class="text-xs">{{ $display }}</span>
                                                            @elseif ($display === "Weekend")
                                                                <span style="color: red;" class="text-xs">{{ $display }}</span>
                                                        ...
                                                        <td class="text-black border border-gray-400 px-1 py-1">
                                                            <div class="flex justify-center items-center">
                                                                ...
                                                                <form action="{{ route('admin_staff.attendance.employee_attendance.deleteTimeIn', $attendanceIn->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this time in?');">
                                                                    @csrf
                                                                    @method('DELETE')
                                                    ...
                                                    <tr class="hover:bg-gray-100">
                                                        ...
                                                        <td class="text-black border border-gray-400 px-1 py-1">
                                                            <div class="flex justify-center items-center space-x-2">
                                                                ...
                                                                <form action="{{ route('admin_staff.attendance.employee_attendance.deleteTimeOut', $attendanceOut->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this time out?');">
                                                                    @csrf
                                                                    @method('DELETE')
                                                                    <button type="submit" class="bg-red-500 text-white text-sm px-2 py-1 rounded hover:bg-red-700">
                                                                        <i class="fa-solid fa-trash fa-xs" style="color: #ffffff;"></i> Delete
                                    ...
                                    <div class="w-full">
                                        <div x-data="{ activeTab: 'form2' }" class="w-[50%] mb-4 mx-auto mt-8">
                                            ...
                                            <div x-show="activeTab === 'form1'" class="w-full">
                                                ...
                                                <form action="{{ route('admin_staff.attendance.modify.halfDay') }}" method="POST" class="w-full">
                                                    <x-caps-lock-detector />
                                                    @csrf
                                            ...
                                            <div x-show="activeTab === 'form2'" class="w-full">
                                                <form action="{{ route('admin_staff.attendance.modify') }}" method="POST" class="w-[78%] mx-auto">
                                                    <x-caps-lock-detector />
                                                    @csrf
                                                    <br>
                                                    <p class="text-[14px]">
                                                                                ...
                                                                                <div class="w-full">
                                                                                    ...
                                                                                    @if ($startDate && $endDate)
                                                                                        ...
                                                                                        <div class="flex justify-between -mt-4">
                                                                                            ...
                                                                                            <p class="py-4 text-red-500">{{ \Carbon\Carbon::createFromFormat('m', str_pad($this->selectedMonth, 2, '0', STR_PAD_LEFT))->format('F') }} {{ $startDate}} to {{ $endDate }}, {{$this->selectedYear}}</p>
                                                                                            <!-- <div class="">
